...
class GPX: NSObject, XMLParserDelegate
{
    ...
    private func parserDidEndDocument(parser: XMLParser) { succeed() }
    @nonobjc func parser(parser: XMLParser, parseErrorOccurred parseError: Error) { fail() }
    @nonobjc func parser(parser: XMLParser, validationErrorOccurred validationError: NSError) { fail() }
